...
export class TargetProperty {
    ...
    */
    ...
    hasProperty(Target : Player, Property: string) {
        if (Property == undefined) { Target.setDynamicProperty(PROPERTY," ")}
    ...
    removeProperty(Target : Player, Property:string) {
        if (Property == undefined) { Target.setDynamicProperty(PROPERTY," ")}
    ...
    addProperty(Target: Player, Property:string) {
        if (Property == undefined) { Target.setDynamicProperty(PROPERTY," ")}
